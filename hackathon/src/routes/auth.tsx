...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sign in to the SentinelAI cyber-transaction correlation console." },
    ],
  }),
  component: AuthPage,
});
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        <div className="mb-6 flex flex-col items-center gap-2">
          ...
          <h1 className="text-2xl font-bold text-glow">SentinelAI</h1>
          <p className="text-[11px] font-mono uppercase tracking-[0.3em] text-muted-foreground">Secure SOC Access</p>
        </div>
