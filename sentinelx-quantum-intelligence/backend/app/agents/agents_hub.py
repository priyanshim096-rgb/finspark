...
class CyberCorrelationAgent(BaseAgent):
    def __init__(self):
        super().__init__("CyberCorrelationAgent", "Specialist in linking cyber threats together")
...
class BehaviorIntelligenceAgent(BaseAgent):
    def __init__(self):
        super().__init__("BehaviorIntelligenceAgent", "Profiler of normal employee behavior")
...
class TransactionIntelligenceAgent(BaseAgent):
    def __init__(self):
        super().__init__("TransactionIntelligenceAgent", "Inspector of money transfer patterns")
...
class InsiderThreatAgent(BaseAgent):
    def __init__(self):
        super().__init__("InsiderThreatAgent", "Tracker of employee risk and behavioral changes")
...
class FraudEvolutionAgent(BaseAgent):
    def __init__(self):
        super().__init__("FraudEvolutionAgent", "Detector of evolving and new fraud styles")
...
class QuantumRiskAgent(BaseAgent):
    def __init__(self):
        super().__init__("QuantumRiskAgent", "Auditor of future decryption hazards")
...
class ExecutiveDecisionAgent(BaseAgent):
    def __init__(self):
        super().__init__("ExecutiveDecisionAgent", "AI narrator that explains security incidents")
