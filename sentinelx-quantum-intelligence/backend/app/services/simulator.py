...
class AttackScenarioSimulator:
    ...
    def _get_step_description(self, step):
        steps = {
            0: "Baseline: Everything is normal. Regular logins, valid certificates, and normal transfer amounts.",
            1: "Step 1: Detected suspicious command runner (PowerShell) on Devon Miller's laptop.",
            2: "Step 2: VPN login from an unusual foreign city (Beijing) using Devon Miller's laptop credentials.",
            3: "Step 3: Intruder logged into the SWIFT Money Gateway Server and stole user passwords from active memory.",
            4: "Step 4: Found weak security locks (RSA-2048) on backup keys that are vulnerable to future decryption attacks (HNDL).",
            5: "Step 5: Employee behavior anomaly flagged—working at odd hours, sending lots of emails, and running unusual commands.",
            6: "Step 6: Attack Climax: An unauthorized high-value transfer ($950,000) was initiated. The AI has generated a complete incident report."
        }
